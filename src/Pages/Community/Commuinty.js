...
export default function Community() {
  return (
    <>
     <div className='md:h-screen mb-80' id='sponser'>
  ...
  {/* <div className=" inset-0 flex items-center justify-center z-20 relative">
    ...
    <div class="flex flex-wrap gap-10 justify-center z-10  max-w-7xl">
      ...
      <div class="p-4 md:w-1/5">
        <div class="h-full  overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-contain object-center" src="https://bmnmsbiymz.ufs.sh/f/1V3V2P4kpAumRKOIeRmu2iQAmoaFD3d9eMskP7J6LXV4IRly" alt="blog"/>
        </div>
      </div>
      <div class="p-4 md:w-1/5">
        <div class="h-full  overflow-hidden">
    ...
    <div class="flex flex-wrap gap-10 justify-center z-10  max-w-7xl">
      <div class="p-4 md:w-1/5">
        <div class="h-full  overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-contain object-center" src="https://bmnmsbiymz.ufs.sh/f/1V3V2P4kpAumQ0Ihntyaj2Z1DfTG5xHuqnQog6vKB4FpJeI8" alt="blog"/>
       
        </div>
      </div>
      <div class="p-4 md:w-1/5">
        <div class="h-full  overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-contain object-center" src="https://bmnmsbiymz.ufs.sh/f/1V3V2P4kpAumj3pBZpEKYdovOsGfC3D9tNMk6nXaAzRVqy05" alt="blog"/>
